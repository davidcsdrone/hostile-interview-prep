...
/** What SessionList needs to display — separate from stored Session shape */
...
// --- Mock data (replace with real sessions later) ---
...
const RECENT_SESSIONS: SessionDisplay[] = [
  { id: "1", company: "Amazon", question: "Tell me about a time you disagreed with a decision.", score: 62, date: "Jul 6" },
      ...
      <main className="flex-1 overflow-y-auto">
        <div className="max-w-3xl mx-auto px-8 py-10 space-y-8">
          <div className="flex items-center justify-between">
            ...
            <button
              type="button"
              onClick={() => router.push('/?company=${selectedCompany}')}
